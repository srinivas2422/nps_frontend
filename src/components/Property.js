    ...
    return (
        <div className="container">
            {properties.map((property) => (
                showDetails ? (
                    <Link to={`/rent/property/${property._id}`} key={property._id} style={{ textDecoration: 'none', color: 'inherit' }}>
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-md-8">
                                    <div className="card-body">
                                        <h5 className="card-title">{property.apartmentType} House For Rent in {property.location}</h5>
                    ...
                    <>
                    <div className="card my-3" key={property._id} style={{ maxWidth: "100%" }}>
            <div className="row g-0">
                <div className="col-md-4">
                    <img
                        src={`http://localhost:5000/${property.imagePath}`}
